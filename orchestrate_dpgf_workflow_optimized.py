...
class FolderProcessor:
    ...
    def process_folder(self, folder_path: str, folder_name: str = None) -> Dict:
        """
        Traite un dossier spécifique et retourne les résultats
        ...
        try:
            ...
            error_msg = f"Erreur lors du traitement du dossier {folder_name}: {str(e)}"
...
class WorkflowOrchestrator:
    ...
    def get_folders_to_process(self, root_folder: str = DEFAULT_ROOT_FOLDER, 
                             folder_filters: List[str] = None) -> List[Dict]:
        """
        Obtient la liste des dossiers à traiter
        ...
        try:
            # Lister les éléments du dossier racine
            ...
            self.logger.error(f"❌ Erreur lors de la récupération des dossiers: {str(e)}")
            raise
        ...
        try:
            ...
            for file_info in identified_files:
                try:
                    ...
                    # S'assurer que le nom n'est pas vide et a une extension
                    if not safe_filename.strip():
                        safe_filename = f"file_{hash(original_name) % 10000}.xlsx"
                    elif not safe_filename.endswith('.xlsx'):
                        safe_filename += '.xlsx'
            ...
            for file_info in downloaded_files:
                ...
                try:
                    ...
                    result = subprocess.run(
                        ...
                        env={**os.environ, 'PYTHONIOENCODING': 'utf-8'}  # S'assurer de l'encodage UTF-8
                    )
